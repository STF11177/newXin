...
@interface informationController ()<UITableViewDelegate,UITableViewDataSource,backViewdelegate>
{
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"7",@"token":tokenStr};
...
-(void)btnClick{
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"7"};
    [self loadDataWithText:param];
}
...
-(void)laodMore{
    ...
    self.recommentTableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"userId":userId,@"createDate":dateStr,@"type":@"7",@"token":tokenStr};
        [weakSelf loadDataWithText:param];
        self.pullMore = NO;
