...
@interface teachChildController ()<UITableViewDelegate,UITableViewDataSource,backViewdelegate>
{
...
@implementation teachChildController
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"4",@"token":tokenStr};
...
-(void)laodMore{
    ...
    self.recommentTableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"userId":userId,@"createDate":dateStr,@"type":@"4",@"token":tokenStr};
        [weakSelf loadDataWithText:param];
        self.pullMore = NO;
