...
//    UIActivityIndicatorViewStyleWhite 的尺寸是（22，22）haokun a  nuhzi
...
//        make.bottom.equalTo(self.bottomView).with.offset(0);
    ...
    self.progressSlider.minimumTrackTintColor = [UIColor colorWithHexString:@"#006fcd"];
...
//        make.left.equalTo(self.leftTimeLabel.mas_right).with.offset(3);
//        
//        make.height.mas_equalTo(20);
//        make.centerY.equalTo(self.bottomView.mas_centerY);
//    }];
    ...
    self.leftTimeLabel.text = [NSString stringWithFormat:@"%@/%@",[self convertTime:nowTime],[self convertTime:remainTime]];
...
- (void)handleSingleTap:(UITapGestureRecognizer *)sender{
    ...
    self.autoDismissTimer = [NSTimer timerWithTimeInterval:3 target:self selector:@selector(autoDismissBottomView:) userInfo:nil repeats:NO];
