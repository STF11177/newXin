...
@interface smallRiseEarlyController ()<UITableViewDataSource,UITableViewDelegate,backViewdelegate>
{
...
@implementation smallRiseEarlyController
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"1",@"token":tokenStr};
...
-(void)laodMore{
    ...
    self.recommentTableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"userId":userId,@"createDate":dateStr,@"type":@"1",@"token":tokenStr};
        [weakSelf loadDataWithText:param];
        self.pullMore = NO;
