...
@interface studyMaterialController ()<UITableViewDelegate,UITableViewDataSource,backViewdelegate>
{
...
@implementation studyMaterialController
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"5",@"token":tokenStr};
...
-(void)loadDataWithText:(NSDictionary *)param{
    ...
    [_manager POST:hotRecommentURL parameters:jsonString success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if (self.dataArray.count == 0) {
            ...
            self.recommentTableView.mj_footer.hidden = YES;
...
-(void)btnClick{
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"5"};
    [self loadDataWithText:param];
}
...
-(void)laodMore{
    ...
    self.recommentTableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"userId":userId,@"createDate":dateStr,@"type":@"5",@"token":tokenStr};
        [weakSelf loadDataWithText:param];
        self.pullMore = NO;
