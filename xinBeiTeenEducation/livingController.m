...
@interface livingController ()<UITableViewDataSource,UITableViewDelegate,backViewdelegate>
{
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"3",@"token":tokenStr};
...
-(void)laodMore{
    ...
    self.recommentTableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"userId":userId,@"createDate":dateStr,@"type":@"3",@"token":tokenStr};
        [weakSelf loadDataWithText:param];
        self.pullMore = NO;
