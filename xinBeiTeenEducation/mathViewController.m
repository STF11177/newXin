...
@interface mathViewController ()<UITableViewDelegate,UITableViewDataSource,textualCellDelegate,backViewdelegate>
{
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"type":@"3",@"CreateDate":@"",@"userId":userId,@"token":tokenStr};
...
-(void)loadMore{
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"type":@"3",@"CreateDate":dateStr,@"userId":userId,@"token":tokenStr};
