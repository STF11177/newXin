...
@interface yongRiseSmallController ()<UITableViewDelegate,UITableViewDataSource,backViewdelegate>
{
...
@implementation yongRiseSmallController
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"2",@"token":tokenStr};
...
-(void)loadMore{
    ...
    self.recommentTableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"userId":userId,@"createDate":dateStr,@"type":@"2",@"token":tokenStr};
        [weakSelf loadDataWithText:param];
        self.pullMore = NO;
