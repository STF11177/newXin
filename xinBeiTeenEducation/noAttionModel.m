...
//                                                   }];
//    //        self.videoMaskView.backgroundColor = [UIColor blackColor];
...
//                
//                [self.videoMaskView.progessView setProgress:0.0 animated:NO];
//                self.playerState = layerStateBuffering;
//                [self.videoMaskView.activityView startAnimating];
//                
...
//            self.playerState = layerStateBuffering;
//            if (!self.videoMaskView.activityView.isAnimating) {
//                [self.videoMaskView.activityView startAnimating];
//            }
//        }
//    }
...
//    // 控制菊花显示、隐藏
//    if (playerState == layerStateBuffering) {
//        [self.videoMaskView.activityView startAnimating];
//    }else if(playerState == Playing){
//        [self.videoMaskView.activityView stopAnimating];//
//    }else if(playerState == ReadyToPlay){
//        [self.videoMaskView.activityView stopAnimating];//
//    }
//    else{
//        [self.videoMaskView.activityView stopAnimating];//
