...
@interface recommentController ()<UITableViewDelegate,UITableViewDataSource,backViewdelegate>
{
...
@implementation recommentController
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"userId":userId,@"createDate":@"",@"type":@"0",@"token":tokenStr};
...
-(void)loadMore{
    ...
    self.recommentTableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"userId":userId,@"createDate":dateStr,@"type":@"0",@"token":tokenStr};
        [weakSelf loadDataWithText:param];
