...
@interface chineseController ()<UITableViewDelegate,UITableViewDataSource,textualCellDelegate,backViewdelegate>
{
...
- (void)viewDidLoad {
    ...
    NSDictionary *param = @{@"type":@"2",@"CreateDate":@"",@"userId":userId,@"token":tokenStr};
...
-(void)loadMore{
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        NSDictionary *param = @{@"type":@"2",@"CreateDate":dateStr,@"userId":userId,@"token":tokenStr};
        weakSelf.pullNew = NO;
        [weakSelf loadAllDataWithParam:param];
